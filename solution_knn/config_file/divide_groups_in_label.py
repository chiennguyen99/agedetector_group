...
def create_file_in_folder_label():
    data_main_train_sort = read.elements_in_each_line_of_file('./data/train/maintrain_sort.txt')
    i = 0
    while i < len(data_main_train_sort):
        ...
        write.file_json(file_path='./data/train/divide_groups_in_label/', name_file=value_check, list_object=standard_list)
